...
Defined in: [src/lib/index.ts:17](https://github.com/cdellacqua/channel.js/blob/main/src/lib/index.ts#L17)
...
> **new ChannelFullError**(): `ChannelFullError`

Defined in: [src/lib/index.ts:18](https://github.com/cdellacqua/channel.js/blob/main/src/lib/index.ts#L18)
