...
Defined in: [src/lib/index.ts:37](https://github.com/cdellacqua/channel.js/blob/main/src/lib/index.ts#L37)
...
> **new ChannelTooManyPendingRecvError**(): `ChannelTooManyPendingRecvError`

Defined in: [src/lib/index.ts:38](https://github.com/cdellacqua/channel.js/blob/main/src/lib/index.ts#L38)
